...
Now that we've created a few graphs, we should stop and consider what narrative information is contained in each plot. 

#### Column/bar charts

We used column and bar charts to display the counts for two categorical variables: 
...
These graphs can be used to convey *comparison* information. For example, we can see from the bar graph that the majority of MLB players are right-handed batters. 
