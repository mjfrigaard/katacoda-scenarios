...
We left off with the line graph in the ``gg-step15-line-01.png` file. The designers of the FiveThirtyEight graph chose to remove the legend and add text labels directly to the graph, which can help communicate the trend to audiences. This practice isn't always the best choice, but it works in this graph for a few reasons which we will cover below. 
...
gg_step16_line_01 <- ComicNewFemalePerc %>% 
  ...
  annotate(geom = "text", x = 2001, y = .45, 
