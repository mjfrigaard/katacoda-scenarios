...
knitr::include_graphics(path = "https://github.com/mjfrigaard/katacoda-scenarios/blob/master/figs/pipe-data-args.png?raw=true")
```
...
Now we have an image file in our `root/` folder above. 
...
```{r 12-bremorse-better-3, echo=FALSE}
# fs::dir_ls("../figs")
knitr::include_graphics(path = "../figs/12-bremore-better.png")
```
