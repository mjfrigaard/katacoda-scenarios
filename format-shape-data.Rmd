...
dplyr::mutate(.data = BobRossStep11, 
          object_category = case_when(
              ...
              present == 1 & str_detect(string = object, pattern = "bush") ~ "bushes",
              present == 1 & str_detect(string = object, pattern = "barn") ~ "buildings",
              present == 1 & str_detect(string = object, pattern = "cabin") ~ "buildings"))
```


```{r}
BobRossStep11 %>% 
  dplyr::filter(str_detect(string = object, pattern = "mountain") | 
                  str_detect(string = object, pattern = "bushes"))
```
...
dplyr::mutate(.data = BobRossStep11, 
          object_category = case_when(
              ...
              present == 1 & str_detect(string = object, pattern = "tree") ~ "trees")) 
```
