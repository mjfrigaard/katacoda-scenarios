...
```{r step2.png, echo=FALSE}
# fs::dir_ls("figs")
knitr::include_graphics(path = "figs/step2.png")
```

```{r 00-538-bob-ross, echo=FALSE}
# fs::dir_ls("figs")
...
```{r 01-orig-bob-ross, echo=FALSE, fig.height=3, fig.width=5}
# fs::dir_ls("figs")
...
```{r 02-long-bob-ross, echo=FALSE, fig.height=3, fig.width=5}
# fs::dir_ls("figs")
...
```{r 03-original-data, echo=FALSE, fig.height=3, fig.width=5}
# fs::dir_ls("figs")
knitr::include_graphics(path = "figs/03-original-data.png")
```

```{r 04-pivot-longer, echo=FALSE, fig.height=3, fig.width=5}
# fs::dir_ls("figs")
knitr::include_graphics(path = "figs/04-pivot-longer.png")
```

```{r 05-pivot-wider, echo=FALSE, fig.height=3, fig.width=5}
# fs::dir_ls("figs")
